...
io.on('connection', function (socket) {
    ...
    redisClient.subscribe('message', 'comment', 'votes', 'closePoll', 'pollTimeout', 'deleteParticipant', 'reopenPoll');
    ...
    redisClient.on("reopenPoll", function(channel, reopenPoll) {
        console.log("new reopenPoll in queue "+ reopenPoll + "channel");
        socket.emit(channel, reopenPoll);
    });
