...
*------------------------------------------------------------*/
    ...
    'label' => [
        ...
        'setting' => [
            ...
            'allow_new_option' => '投票者にとって答えを追加する可能があります',
            ...
            'number_of_vote' => '投票数のみを表示する',
            'parent_hide_result' => '投票結果を非表示にする',
        ],
        'step_4' => '投票者',
        ...
        'input_date' => '日付をしか入力しません',
        'add_an_image' => 'イメージを追加',
        'add_a_description' => 'デスクリプションを追加',
    ],
    'label_for' => [
        'full_name' => '名前',
        'email' => 'メール',
    ...
    'validation' => [
        ...
        'date_close' => [
            'format' => '投票終了日は「d-m-Y」形式でなければいけません。',
        ],
        'member' => [
            'format' => "参加者のメールは正しくありません。",
        ],
    ],
    'table' => [
        'thead' => [
    ...
    'message_client' => [
      ...
      'off' => 'オフ',
        ...
        'empty_url_image' => 'URLの入力またはアップロードのクリックをしてください。',
        'not_type_url_image' => '映像ファイル形が間違っています。',
        'time_out_url_image' => '映像リンクが間違っています。',
        'max_size_image' => '映像ファイル量は10240KB (10MB)までアップロードしてください。',
        'email_exists' => 'このメールはシステムに存在しています。他のメールで投票してください。',
        'error_occurs' => 'エラーが発生しています。',
        'success_comment' => 'コメントに成功しました。',
        'fail_comment' => 'コメントに失敗しました。',
        'type_email_invalid' => 'メールフォマットが間違っています。',
        'show_more' => 'もっと見る。',
        'show_less' => '示さなくなる。',
        'type_option_description' => '。。。オプションについて説明を入力してください。',
...
*------------------------------------------------------------*/
    ...
    'required_type_email' => 'メールに:type拡張が必要です。',
