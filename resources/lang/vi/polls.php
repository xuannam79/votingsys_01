...
*------------------------------------------------------------*/
    ...
    'label' => [
        ...
        'setting' => [
            ...
            'hide_result' => 'Ẩn tất cả thông tin kết quả bầu chọn',
            ...
            'disable_voting' => 'Vô hiệu hóa bầu chọn',
            'number_of_vote' => 'Chỉ hiển thị số lượng người bình chọn',
            'parent_hide_result' => 'Ẩn kết quả bầu chọn',
        ],
    ...
    'message' => [
        ...
        'not_param_token' => 'Không có tham số token'
    ],
    'validation' => [
        'name' => [
    ...
    'message_client' => [
        ...
        'max_size_image' => 'Kích thước tối đa của hình ảnh là 1024KB (1MB)',
